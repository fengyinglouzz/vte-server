...
public class SymmetricEncoder {
	private  static String encodeRules = "alskdjfhgqpwoeirtuy";
 
	public static void main(String[] args) {
		String content="舍非yy";
		
		System.out.println("加密后的密文为："+AESEncode(content));
		System.out.println("解密后的明文为："+AESDncode(AESEncode(content)));
	}
